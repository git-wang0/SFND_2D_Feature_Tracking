...
int main(int argc, const char *argv[])
{
    ...
    std::ofstream output;
    output.open("../Task89_match.csv");
    output << "imgNo, keypointType, descriptorType, number of keypoints, number of mached points, time for keypoints, time for descriptor" << std::endl;
                ...
                for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
                {
                    ...
                    if (dataBuffer.size() > 1) // wait until at least two images have been processed
                    {
                        ...
                        if (descriptorType == "SIFT"){
                            ...
                            // std::cout << "SIFT as descriptor" << std::endl; // DES_BINARY, DES_HOG
                        }
                        else
                        ...
                        output << imgIndex << "," << detectorType << "," << descriptorType_list[dscpIndex] << "," << Nkpt << "," << Nmatch << "," << std::to_string((t1)*1000) <<"," << std::to_string((t2)*1000) <<  std::endl;
